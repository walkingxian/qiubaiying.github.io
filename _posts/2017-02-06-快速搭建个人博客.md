...
email: You@gmail.com	            # eamil地址
description: "You Blog"  			#网站介绍
keyword: "BY, BY Blog, 小贤的博客, lijunxian" #关键词
...
sidebar-about-description: "说点装逼的话。。。" # 侧边介绍
...
在下面写文章，和标题，最后提交保存就能看到自己的新文章了。

## 格式
每一篇文章文件命名采用的是`2017-02-04-文章标题.md`时间+标题的形式，空格用`-`替换连接。
...
搭建好博客之后 你可能不想直接使用 [walkingxian.github.io](http://walkingxian.github.io) 这么长的博客域名吧, 想换成想 [lijunxian.pw](http://lijunxian.pw) 这样简短的域名。那我们开始吧！

#### 购买域名
首先，你必须购买一个自己的域名。

我是在[阿里云](https://wanwang.aliyun.com/)购买的域名
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/walkingxian/walkingxian.github.io) 点个 **star** 吧！

### **别无他求，点个 [Star](https://github.com/walkingxian/walkingxian.github.io) 吧**！
